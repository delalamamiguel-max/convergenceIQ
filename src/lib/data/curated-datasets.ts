...
export const activeListings: ActiveListing[] = [
  // United States
  { id: 'al-us-1', company: 'Anthropic', role: 'Product Manager, Claude Platform', location: 'San Francisco, CA (Hybrid)', seniority: 'Senior', source: 'LinkedIn', postedDate: 'Active as of May 2026', relevance: 'AI-native company building frontier models. Direct AI PM work — scoping model capabilities into product features, exactly where the highest demand and salary premium sit.', geoView: 'us', url: 'https://www.anthropic.com/careers#open-roles' },
  { id: 'al-us-2', company: 'Stripe', role: 'Product Manager, Payments Infrastructure', location: 'San Francisco, CA or Seattle, WA', seniority: 'Senior', source: 'Stripe Careers', postedDate: 'Active as of May 2026', relevance: 'Technical PM role on payments platform. API-first product thinking, developer experience focus, and infrastructure-level complexity — strong fit for Technical PM specialization.', geoView: 'us', url: 'https://stripe.com/jobs/search?query=product+manager' },
  { id: 'al-us-3', company: 'Datadog', role: 'Senior Product Manager, AI Integrations', location: 'New York, NY (Hybrid)', seniority: 'Senior', source: 'LinkedIn', postedDate: 'Active as of May 2026', relevance: 'Intersection of AI PM and Technical PM. Building AI-powered observability features for developers — combines platform product experience with AI capability scoping.', geoView: 'us', url: 'https://careers.datadoghq.com/search/#?keyword=product%20manager' },
  { id: 'al-us-4', company: 'Notion', role: 'Product Manager, AI Features', location: 'San Francisco, CA (Hybrid)', seniority: 'Mid-Senior', source: 'Notion Careers', postedDate: 'Active as of May 2026', relevance: 'AI PM role at a productivity tool company. Shipping LLM-powered features to millions of users — high-visibility AI product work with direct user impact measurement.', geoView: 'us', url: 'https://www.notion.com/careers' },
  { id: 'al-us-5', company: 'Figma', role: 'Product Manager, Platform & Ecosystem', location: 'San Francisco, CA (Hybrid)', seniority: 'Senior', source: 'LinkedIn', postedDate: 'Active as of May 2026', relevance: 'Platform PM role focused on developer ecosystem and plugin marketplace. Strong Technical PM fit — API design, third-party developer experience, and platform growth strategy.', geoView: 'us', url: 'https://www.figma.com/careers/#job-openings' },
  { id: 'al-us-6', company: 'Plaid', role: 'Product Manager, Data Products', location: 'San Francisco, CA or Salt Lake City, UT', seniority: 'Mid-Senior', source: 'Plaid Careers', postedDate: 'Active as of May 2026', relevance: 'Fintech data platform role. API product management, regulatory-aware product decisions (financial data handling), and B2B product strategy in a high-growth vertical.', geoView: 'us', url: 'https://plaid.com/careers/openings/' },
  { id: 'al-us-7', company: 'Verkada', role: 'Product Manager, AI/ML', location: 'San Mateo, CA', seniority: 'Mid-Senior', source: 'LinkedIn', postedDate: 'Active as of May 2026', relevance: 'AI PM at the intersection of hardware and software. Computer vision product features for physical security — a differentiated AI PM niche with less competition than pure-software AI roles.', geoView: 'us', url: 'https://www.verkada.com/careers/search/#openings' },
  { id: 'al-us-8', company: 'HubSpot', role: 'Principal Product Manager, AI-Powered CRM', location: 'Cambridge, MA (Hybrid)', seniority: 'Principal', source: 'HubSpot Careers', postedDate: 'Active as of May 2026', relevance: 'Senior AI PM role embedding LLM capabilities into enterprise CRM. High-impact role translating AI into revenue features for millions of SMBs — strong growth PM angle too.', geoView: 'us', url: 'https://www.hubspot.com/careers/jobs?query=product+manager' },
  { id: 'al-us-9', company: 'Scale AI', role: 'Product Manager, Enterprise Platform', location: 'San Francisco, CA', seniority: 'Senior', source: 'LinkedIn', postedDate: 'Active as of May 2026', relevance: 'AI infrastructure company. PM role on the enterprise platform that powers AI training data for government and Fortune 500 — deep AI domain with enterprise product complexity.', geoView: 'us', url: 'https://scale.com/careers#open-positions' },
  { id: 'al-us-10', company: 'Ramp', role: 'Growth Product Manager', location: 'New York, NY', seniority: 'Mid-Senior', source: 'Ramp Careers', postedDate: 'Active as of May 2026', relevance: 'Pure Growth PM role at one of the fastest-growing fintech companies. Metric-driven experimentation, activation/retention funnels, and PLG motion — exactly the skills that command a Growth PM premium.', geoView: 'us', url: 'https://ramp.com/careers#openings' },

  // Austin, Texas
  { id: 'al-atx-1', company: 'Apple', role: 'Product Manager, Apple Intelligence', location: 'Austin, TX', seniority: 'Senior', source: 'Apple Careers', postedDate: 'Active as of May 2026', relevance: 'AI PM at Apple Austin campus. Working on Apple Intelligence features that ship to billions of devices — massive scale AI product work with Austin-local presence.', geoView: 'austin', url: 'https://jobs.apple.com/en-us/search?location=austin-AUS&team=product-management' },
  { id: 'al-atx-2', company: 'Oracle', role: 'Senior Product Manager, OCI AI Services', location: 'Austin, TX (Hybrid)', seniority: 'Senior', source: 'LinkedIn', postedDate: 'Active as of May 2026', relevance: 'Enterprise AI PM role. Building AI services for Oracle Cloud Infrastructure — cloud platform product work with AI specialization at a company investing heavily in Austin.', geoView: 'austin', url: 'https://careers.oracle.com/jobs/#en/sites/jobsearch/requisitions?keyword=product+manager&location=Austin' },
  { id: 'al-atx-3', company: 'Indeed', role: 'Product Manager, Search & Recommendations', location: 'Austin, TX (Hybrid)', seniority: 'Mid-Senior', source: 'Indeed Careers', postedDate: 'Active as of May 2026', relevance: 'Technical PM role on search and ML-powered recommendations. Indeed is Austin-native — deep local network, strong engineering culture, and AI/ML product integration at scale.', geoView: 'austin', url: 'https://www.indeed.com/cmp/Indeed/jobs?q=product+manager&l=Austin%2C+TX' },
  { id: 'al-atx-4', company: 'Tesla', role: 'Technical Product Manager, Energy Products', location: 'Austin, TX', seniority: 'Senior', source: 'Tesla Careers', postedDate: 'Active as of May 2026', relevance: 'Technical PM at Tesla Austin HQ. Energy products (Powerwall, Megapack) sit at the intersection of hardware, software, and clean energy — differentiated product domain.', geoView: 'austin', url: 'https://www.tesla.com/careers/search/?query=product%20manager&location=austin' },
  { id: 'al-atx-5', company: 'WP Engine', role: 'Product Manager, AI Content Tools', location: 'Austin, TX (Hybrid)', seniority: 'Mid-Senior', source: 'LinkedIn', postedDate: 'Active as of May 2026', relevance: 'AI PM at an Austin-native company. Integrating AI content generation into WordPress hosting platform — practical AI product work for a large creator/SMB user base.', geoView: 'austin', url: 'https://wpengine.com/careers/#open-positions' },
  { id: 'al-atx-6', company: 'CrowdStrike', role: 'Product Manager, Threat Intelligence Platform', location: 'Austin, TX (Hybrid)', seniority: 'Senior', source: 'CrowdStrike Careers', postedDate: 'Active as of May 2026', relevance: 'Cybersecurity platform PM in Austin. ML-powered threat detection, real-time data products, and enterprise security — a high-growth vertical with strong regulatory tailwinds.', geoView: 'austin', url: 'https://www.crowdstrike.com/careers/job-listing/?query=product+manager&location=Austin' },
  { id: 'al-atx-7', company: 'Bumble', role: 'Growth Product Manager', location: 'Austin, TX', seniority: 'Mid-Senior', source: 'LinkedIn', postedDate: 'Active as of May 2026', relevance: 'Growth PM at Austin-headquartered consumer tech company. User acquisition, retention experiments, and PLG metrics — direct Growth PM specialization with Austin-local presence.', geoView: 'austin', url: 'https://bumble.com/careers#open-positions' },
  { id: 'al-atx-8', company: 'Procore Technologies', role: 'Product Manager, AI & Automation', location: 'Austin, TX', seniority: 'Mid-Senior', source: 'Procore Careers', postedDate: 'Active as of May 2026', relevance: 'AI PM in construction tech (vertical SaaS). Applying AI to a traditional industry with massive efficiency gains — less competitive than pure-tech AI PM roles with similar comp.', geoView: 'austin', url: 'https://www.procore.com/jobs/openings?query=product+manager' },

  // Austin Surrounding Areas
  { id: 'al-atxs-1', company: 'Dell Technologies', role: 'Senior Product Manager, AI Infrastructure', location: 'Round Rock, TX', seniority: 'Senior', source: 'Dell Careers', postedDate: 'Active as of May 2026', relevance: 'AI PM at the largest employer in Round Rock. Building AI server and infrastructure products — hardware-meets-AI product work with enterprise scale and strong local job stability.', geoView: 'austin-surrounding', url: 'https://jobs.dell.com/en/search-jobs/product%20manager/375/1?fl=6252001,4736286,4726206' },
  { id: 'al-atxs-2', company: 'Dell Technologies', role: 'Product Manager, APEX Cloud Platform', location: 'Round Rock, TX', seniority: 'Mid-Senior', source: 'Dell Careers', postedDate: 'Active as of May 2026', relevance: 'Cloud platform PM at Dell. APEX is Dell\'s as-a-service platform — Technical PM work on infrastructure products with subscription/consumption model. Stable employer, solid comp.', geoView: 'austin-surrounding', url: 'https://jobs.dell.com/en/search-jobs/product%20manager/375/1?fl=6252001,4736286,4726206' },
  { id: 'al-atxs-3', company: 'Emerson', role: 'Product Manager, Industrial Automation Software', location: 'Round Rock, TX', seniority: 'Mid-Senior', source: 'LinkedIn', postedDate: 'Active as of May 2026', relevance: 'Industrial IoT product management. Software platform for manufacturing automation — niche but defensible domain with less competition from traditional tech PMs.', geoView: 'austin-surrounding', url: 'https://www.emerson.com/en-us/careers/job-search#q=product%20manager&loc=Round%20Rock' },
  { id: 'al-atxs-4', company: 'Kalahari Resorts', role: 'Product Manager, Digital Experience', location: 'Round Rock, TX', seniority: 'Mid', source: 'Indeed', postedDate: 'Active as of May 2026', relevance: 'Consumer digital product role (booking, in-resort app, guest experience). Lower comp than tech PM but lower barrier to entry — possible stepping stone for career switchers in the area.', geoView: 'austin-surrounding', url: 'https://www.kalahariresorts.com/careers/' },

  // Remote (US)
  { id: 'al-rem-1', company: 'Vercel', role: 'Product Manager, Developer Experience', location: 'Remote (US)', seniority: 'Senior', source: 'Vercel Careers', postedDate: 'Active as of May 2026', relevance: 'Remote-first developer tools company. Technical PM role on DX — the workflow developers use daily. API design, deployment UX, and platform thinking at a company defining the modern web stack.', geoView: 'remote', url: 'https://vercel.com/careers#open-positions' },
  { id: 'al-rem-2', company: 'Supabase', role: 'Product Manager, AI & Vector', location: 'Remote (Global)', seniority: 'Senior', source: 'LinkedIn', postedDate: 'Active as of May 2026', relevance: 'AI + Technical PM at an open-source database platform. Vector search, AI integrations, and developer tools — remote-first with strong open-source community engagement.', geoView: 'remote', url: 'https://supabase.com/careers#positions' },
  { id: 'al-rem-3', company: 'GitLab', role: 'Principal Product Manager, AI-Powered DevSecOps', location: 'Remote (US)', seniority: 'Principal', source: 'GitLab Careers', postedDate: 'Active as of May 2026', relevance: 'Senior AI PM at a fully remote public company. Embedding AI into the developer workflow — code generation, vulnerability detection, review automation. Remote-first culture since founding.', geoView: 'remote', url: 'https://about.gitlab.com/jobs/all-jobs/#product' },
  { id: 'al-rem-4', company: 'Zapier', role: 'Product Manager, AI Automation', location: 'Remote (US)', seniority: 'Mid-Senior', source: 'Zapier Careers', postedDate: 'Active as of May 2026', relevance: 'AI PM at the leading automation platform. Building AI-powered workflow creation for millions of non-technical users — AI product work with direct consumer impact and PLG metrics.', geoView: 'remote', url: 'https://zapier.com/jobs#job-openings' },
  { id: 'al-rem-5', company: 'Webflow', role: 'Growth Product Manager', location: 'Remote (US)', seniority: 'Mid-Senior', source: 'LinkedIn', postedDate: 'Active as of May 2026', relevance: 'Growth PM at a PLG design tool. Self-serve acquisition, activation, and expansion — pure Growth PM work at a remote-first company with strong product-led motion.', geoView: 'remote', url: 'https://webflow.com/careers#open-positions' },
  { id: 'al-rem-6', company: 'Postman', role: 'Product Manager, API Platform', location: 'Remote (US)', seniority: 'Senior', source: 'Postman Careers', postedDate: 'Active as of May 2026', relevance: 'Technical PM on the most-used API development platform. Developer tools, API design, and ecosystem growth — deep Technical PM work in a remote-first environment.', geoView: 'remote', url: 'https://www.postman.com/company/careers/open-positions/' },
  { id: 'al-rem-7', company: 'Loom (Atlassian)', role: 'Product Manager, AI Features', location: 'Remote (US)', seniority: 'Mid-Senior', source: 'LinkedIn', postedDate: 'Active as of May 2026', relevance: 'AI PM building smart video features (auto-summaries, chapters, search). Consumer-facing AI with enterprise distribution through Atlassian — AI product work with dual-market reach.', geoView: 'remote', url: 'https://www.atlassian.com/company/careers/all-jobs?search=product+manager&team=Loom' },
  { id: 'al-rem-8', company: 'Linear', role: 'Product Manager', location: 'Remote (US/EU)', seniority: 'Mid-Senior', source: 'Linear Careers', postedDate: 'Active as of May 2026', relevance: 'Generalist PM at one of the most respected product-led developer tools. Small team, high autonomy, and extreme attention to product craft — great resume signal and skill development.', geoView: 'remote', url: 'https://linear.app/careers#open-positions' },
  { id: 'al-rem-9', company: 'Descript', role: 'Product Manager, AI Editing', location: 'Remote (US)', seniority: 'Mid-Senior', source: 'Descript Careers', postedDate: 'Active as of May 2026', relevance: 'AI PM at a creative tools startup. AI-powered video/audio editing — generative AI product work in a consumer-friendly domain. Less crowded than enterprise AI PM applications.', geoView: 'remote', url: 'https://www.descript.com/careers#positions' },
  { id: 'al-rem-10', company: 'Mercury', role: 'Product Manager, Banking Platform', location: 'Remote (US)', seniority: 'Senior', source: 'LinkedIn', postedDate: 'Active as of May 2026', relevance: 'Fintech platform PM. Building banking products for startups — regulatory-aware product decisions, API-first architecture, and Growth PM elements in customer acquisition.', geoView: 'remote', url: 'https://mercury.com/jobs#openings' },
];

export const jobMarketSignals: JobMarketSignal[] = [
  { id: 'jms-us', geoView: 'us', summary: 'The national PM hiring picture is strong and tilted toward specialization. AI PM roles dominate the highest-comp postings, with companies like Anthropic, Scale AI, and HubSpot actively recruiting. Technical PM demand remains robust at infrastructure and platform companies (Stripe, Figma, Plaid). Growth PM is concentrating at high-velocity fintech and PLG companies. The overall signal: generalist PM hiring continues, but the premium postings — the ones paying $170K+ — overwhelmingly require either AI fluency, technical platform experience, or demonstrated growth experimentation skills. Companies are not just posting roles; they are posting for specific capabilities.' },
  { id: 'jms-atx', geoView: 'austin', summary: 'Austin PM hiring reflects the city\'s evolution into a top-5 tech hub. Apple, Oracle, Tesla, and CrowdStrike are actively hiring PMs with AI and technical specializations. The Austin-specific signal: local companies are competing with SF and NYC for the same AI PM talent, which means comp packages are rising to stay competitive. Indeed remains the largest Austin-native PM employer, and Bumble offers one of the few pure Growth PM seats in the city. Companies hiring locally want candidates who will engage with the Austin tech community — networking here is not optional, it is part of the hiring signal.' },
  { id: 'jms-atxs', geoView: 'austin-surrounding', summary: 'The surrounding areas confirm the pattern from the aggregate data: Round Rock is the only suburb with meaningful PM hiring, and Dell dominates that market. Emerson adds a niche industrial-tech option. Outside Round Rock, the listing density drops sharply — Georgetown, Leander, San Marcos, and Pflugerville have essentially no dedicated PM roles from major employers. The realistic path for PM candidates living in these areas: commute to Austin or Round Rock for on-site roles, or focus on the remote channel. Do not plan a job search around suburban employer density.' },
  { id: 'jms-rem', geoView: 'remote', summary: 'Remote PM hiring is mature, competitive, and heavily weighted toward developer tools and AI companies. Vercel, Supabase, GitLab, Zapier, and Linear are all remote-first by design — not pandemic adaptations. The remote signal: these companies evaluate candidates primarily on portfolio, written communication, and async collaboration skills. Remote AI PM (Supabase, GitLab, Zapier, Descript) offers the best comp-to-flexibility ratio in the market. Remote Growth PM (Webflow, Mercury) rewards demonstrated experiment results over pedigree. The competition per listing is 3-5x higher than local roles, so application quality matters more than volume.' },
];
