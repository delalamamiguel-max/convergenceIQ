...
export const activeListings: ActiveListing[] = [
  // United States
  { id: 'al-us-1', company: 'Anthropic', role: 'Product Manager, Claude Platform', location: 'San Francisco, CA (Hybrid)', seniority: 'Senior', source: 'LinkedIn', postedDate: 'Active as of May 2026', relevance: 'AI-native company building frontier models. Direct AI PM work — scoping model capabilities into product features, exactly where the highest demand and salary premium sit.', geoView: 'us' },
