  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-lg font-bold text-[var(--dash-text-1)]">Entrepreneurship Intelligence</h2>
          <p className="text-xs text-[var(--dash-text-4)]">Disruption reports · Corruption index · Cultural trends · Tech adoption forecasts</p>
        </div>
      </div>
        ...
        {scores.slice(0, 4).map((score, i) => (
          <div key={i} className="rounded-xl border p-3 transition-colors" style={{ backgroundColor: 'var(--dash-bg-card)', borderColor: 'var(--dash-border)' }}>
            ...
            <div className="flex items-end justify-between">
              <div className="text-2xl font-bold text-emerald-500 dark:text-emerald-400">{score.score.toFixed(0)}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="rounded-xl border p-4 transition-colors" style={{ backgroundColor: 'var(--dash-bg-card)', borderColor: 'var(--dash-border)' }}>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-semibold text-[var(--dash-text-1)]">Startup Disruption Index</h3>
            <Badge variant="outline" className="text-[10px] border-[var(--dash-border)] text-[var(--dash-text-4)]">Crunchbase Open</Badge>
          </div>
        ...
        <div className="rounded-xl border p-4 transition-colors" style={{ backgroundColor: 'var(--dash-bg-card)', borderColor: 'var(--dash-border)' }}>
          <div className="flex items-center gap-2 mb-4">
            <Globe2 className="w-4 h-4 text-emerald-500 dark:text-emerald-400" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="rounded-xl border p-4 transition-colors" style={{ backgroundColor: 'var(--dash-bg-card)', borderColor: 'var(--dash-border)' }}>
          <div className="flex items-center gap-2 mb-4">
            <Globe2 className="w-4 h-4 text-emerald-500 dark:text-emerald-400" />
            <h3 className="text-sm font-semibold text-[var(--dash-text-1)]">Corruption Perception Index</h3>
            <Badge variant="outline" className="text-[10px] border-[var(--dash-border)] text-[var(--dash-text-4)]">Transparency Intl</Badge>
          </div>
        ...
        <div className="rounded-xl border p-4 transition-colors" style={{ backgroundColor: 'var(--dash-bg-card)', borderColor: 'var(--dash-border)' }}>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-semibold text-[var(--dash-text-1)]">Technology Adoption Forecasts</h3>
            <Badge variant="outline" className="text-[10px] border-[var(--dash-border)] text-[var(--dash-text-4)]">Industry Data</Badge>
          </div>
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-sm font-semibold text-[var(--dash-text-1)]">Cultural & Social Trends</h3>
          <Badge variant="outline" className="text-[10px] border-[var(--dash-border)] text-[var(--dash-text-4)]">Pew Research</Badge>
        </div>
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          <Cpu className="w-4 h-4 text-blue-500 dark:text-blue-400" />
          <h3 className="text-sm font-semibold text-[var(--dash-text-1)]">Technology Adoption Signals</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
